...
namespace ECommerce.Repositories
{
    public class ProductRepository
    {
        ...
        public int Add(Product product)
        {
            using (var connection = new MySqlConnection(this.connectionString))
            {
                return connection.Execute("INSERT INTO Products (name, description, price, typeid, balance, imageurl) VALUES (@name, @description, @price, @typeid, @balance, @imageurl); SELECT LAST_INSERT_ID()", product);
            }
        }
